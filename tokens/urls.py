...
urlpatterns = patterns(
    ...
    url(r'^change/(?P<pk>\d+)/$', TokenChangeView.as_view(), name="change_token"),
    url(r'^delete/(?P<pk>\d+)/$', TokenDeleteView.as_view(), name="delete_token"),
    url(r'^disable/(?P<pk>\d+)/$', TokenDisableView.as_view(), name="disable_token"),

    url(r'^readers/$', ReaderListView.as_view(), name="readers"),
    url(r'^readers/add/$', ReaderCreateView.as_view(), name="add_reader"),
    url(r'^readers/change/(?P<pk>\d+)/$', ReaderChangeView.as_view(), name="change_reader"),
    url(r'^readers/delete/(?P<pk>\d+)/$', ReaderDeleteView.as_view(), name="delete_reader"),
    url(r'^readers/disable/(?P<pk>\d+)/$', ReaderDisableView.as_view(), name="disable_reader"),
