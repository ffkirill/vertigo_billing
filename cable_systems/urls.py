...
urlpatterns = patterns(
    ...
    url(r'^change/(?P<pk>\d+)/$', CableChangeView.as_view(), name="change_cable"),
    url(r'^delete/(?P<pk>\d+)/$', CableDeleteView.as_view(), name="delete_cable"),
    url(r'^disable/(?P<pk>\d+)/$', CableDisableView.as_view(), name="disable_cable"),
